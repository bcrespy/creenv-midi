...
class Capture {
  ...
  constructor (project, options) {
     ...
     */
    this.controls = new CaptureControls(this.onPlay, this.onPause, this.onRecord, this.onStop, this.onPrev, this.onNext, this.onCapture, this.options.framerate, this.options.infobox);
